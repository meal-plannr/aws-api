...
public class TableUtils {
    ...
    public static void waitUntilExists(final DynamoDbClient dynamo, final String tableName, final int timeout,
        ...
        final TableDescription table = waitForTableDescription(dynamo, tableName, null, timeout, interval);

        if (table == null) {
            throw new IllegalStateException("Table " + tableName + " never returned a result");
        }
    }
    ...
    public static void waitUntilActive(final DynamoDbClient dynamo, final String tableName, final int timeout,
        ...
        final TableDescription table = waitForTableDescription(dynamo, tableName, TableStatus.ACTIVE, timeout, interval);
     ...
     */
    public static class TableNeverTransitionedToStateException extends IllegalStateException {

        private static final long serialVersionUID = 8920567021104846647L;

        public TableNeverTransitionedToStateException(final String tableName, final TableStatus desiredStatus) {
